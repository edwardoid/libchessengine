...
\item[Enumerator: ]\par
\begin{description}
\index{WhiteSide@{WhiteSide}!ChEngn@{ChEngn}}\index{ChEngn@{ChEngn}!WhiteSide@{WhiteSide}}\item[{\em 
...
}]$<$-\/ Default value \index{BlackSide@{BlackSide}!ChEngn@{ChEngn}}\index{ChEngn@{ChEngn}!BlackSide@{BlackSide}}\item[{\em 
...
}]$<$-\/ White player's side $<$-\/ Black Player side \end{description}
\end{Desc}
