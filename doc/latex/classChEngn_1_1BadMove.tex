...
{\em p} & \hyperlink{classpgn_1_1Ply}{pgn::Ply} which can be done a.t.m. \\
\hline
{\em comm} & Addiotional comment \\
\hline
{\em moveNum} & \hyperlink{classChEngn_1_1Move}{Move} number which can't be completly done \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em num} & \hyperlink{classChEngn_1_1Move}{Move} number \\
\hline
\end{DoxyParams}
...
\item 
src/CEException.h\end{DoxyCompactItemize}
