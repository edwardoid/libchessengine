...
\hyperlink{classChEngn_1_1Enumerator}{Enumerator} possibilites. Enumerate possible moves in given deep 
...
\item[{\em table}]Start position for enumeration \item[{\em side}]Enumeration side, default value ChEngn::UndefinedSide \item[{\em deep}]Enumeration deep : Enumeration process is hard process, if it's possible use small values for deep \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em deep}]Enumeration depness \end{DoxyParams}
...
Sets enumeration side 
\begin{DoxyParams}{Parameters}
\item[{\em enumSide}]Enumeration side \end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
\item[{\em table}]Start position \end{DoxyParams}
